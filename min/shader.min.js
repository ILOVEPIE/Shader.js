...
case "Matrix2fv":a.uniformMatrix2fv(f,!1,this.a[b].b);break;case "Matrix3fv":a.uniformMatrix3fv(f,!1,this.a[b].b);break;case "Matrix4fv":a.uniformMatrix4fv(f,!1,this.a[b].b)}}},writable:!1},getShader:{value:function(){return this.d},writable:!1},compile:{value:function(a,e){var d;this.d=d=a.createProgram();this.i=this.g(a,this.f,a.VERTEX_SHADER);this.h=this.g(a,this.e,a.FRAGMENT_SHADER);a.attachShader(d,this.i);a.attachShader(d,this.h);a.linkProgram(d);if(!a.getProgramParameter(d,a.LINK_STATUS)){var b=
a.getProgramInfoLog(d);a.deleteProgram(d);a.deleteShader(this.i);a.deleteShader(this.h);if(e)e();else throw Error(b);}},writable:!1},g:{value:function(a,e,d){var b;b="#ifdef GL_ES\nprecision highp float;\n#endif\n";d=a.createShader(d);a.shaderSource(d,b+e);a.compileShader(d);return a.getShaderParameter(d,a.COMPILE_STATUS)?d:(console.debug(a.getShaderInfoLog(d)),a.deleteShader(d),null)}}});
